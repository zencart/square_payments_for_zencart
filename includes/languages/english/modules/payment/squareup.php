...
define('MODULE_PAYMENT_SQUAREUP_ERROR_INVALID_CARD_DATA',
...
define('MODULE_PAYMENT_SQUAREUP_TEXT_NEED_ACCESS_TOKEN',
    '<span class="text-danger"><strong>ALERT: Access Token not set:</strong></span> 
     <a href="%s" target="_blank"><button class="btn btn-xs btn-success">Click here to login and Authorize your account</button></a>');
